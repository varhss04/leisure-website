...
const BlogLightBooks = () => {
  ...
  useEffect(() => {
    axios
      .get('http://localhost:5000/blog-dark-books')
  ...
  const savePost = () => {
    if (newPostContent.trim()) {
      axios
        .post('http://localhost:5000/blog-dark-books', { content: newPostContent })
        .then((response) => {
  ...
  const deletePost = (id) => {
    axios
      .delete(`http://localhost:5000/blog-dark-books/${id}`)
  ...
  return (
    <div style={styles.body}>
      <div style={styles.header}>
        <div style={styles.brand}>Leisure books</div>
